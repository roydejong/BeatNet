...
public sealed class SetGameplaySongReadyRpc : BaseGameplayRpc
{
	public override GameplayRpcType RpcType => GameplayRpcType.SetGameplaySongReady;
	...
	public static readonly SetGameplaySongReadyRpc Instance = new();
}