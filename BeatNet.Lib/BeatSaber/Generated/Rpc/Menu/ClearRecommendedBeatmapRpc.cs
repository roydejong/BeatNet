...
public sealed class ClearRecommendedBeatmapRpc : BaseMenuRpc
{
	public override MenuRpcType RpcType => MenuRpcType.ClearRecommendedBeatmap;
	...
	public static readonly ClearRecommendedBeatmapRpc Instance = new();
}