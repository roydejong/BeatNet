...
public sealed class ClearSelectedBeatmapRpc : BaseMenuRpc
{
	public override MenuRpcType RpcType => MenuRpcType.ClearSelectedBeatmap;
	...
	public static readonly ClearSelectedBeatmapRpc Instance = new();
}