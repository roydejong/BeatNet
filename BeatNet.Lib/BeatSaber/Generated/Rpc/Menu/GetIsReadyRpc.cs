...
public sealed class GetIsReadyRpc : BaseMenuRpc
{
	public override MenuRpcType RpcType => MenuRpcType.GetIsReady;

	public GetIsReadyRpc()
	{
		// RPC without parameters
	}

	public static readonly GetIsReadyRpc Instance = new();
}