...
public sealed class GetRecommendedBeatmapRpc : BaseMenuRpc
{
	public override MenuRpcType RpcType => MenuRpcType.GetRecommendedBeatmap;
	...
	public static readonly GetRecommendedBeatmapRpc Instance = new();
}