...
public sealed class LevelLoadSuccessRpc : BaseMenuRpc
{
	public override MenuRpcType RpcType => MenuRpcType.LevelLoadSuccess;

	public string? LevelId { get; set; } = null;

	public LevelLoadSuccessRpc(string? levelId = null)
	{
		LevelId = levelId;
	}
